...
/**
 * PetitionerLayout Component
 *
 * This component wraps routes specifically intended for users with the "petitioner" role.
 * It checks for authentication and the correct user role using `useUserStore`.
 * - If the user is not logged in, it redirects to the login page.
 * - If the user is logged in but does not have the "petitioner" role,
 ...
 */
const PetitionerLayout = ({ children }: { children: React.ReactNode }): React.ReactElement | null => {
    ...
    const isAuthorized = user && user.role === "petitioner";
...
export default PetitionerLayout;
